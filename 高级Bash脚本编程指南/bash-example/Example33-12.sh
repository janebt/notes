...
# ROW 和COLUMN 定位要画的盒子的左上角. 
# 
# ROW 和COLUMN 必须要大于0且小于目前终端的尺寸. 
# 
# HEIGHT 是盒子的行数,必须> 0. 
# HEIGHT + ROW 必须<= 终端的高度. 
# WIDTH 是盒子的列数,必须> 0. 
...
#   draw_box 2 3 19 45 的HEIGHT 值是错的 (19+2 > 20) 
#   draw_box 2 3 18 78 的WIDTH 值是错的(78+3 > 80) 
# 
# COLOR 是盒子边框的颜色. 
#  它是第5个参数,并且它是可选的. 
# 0=黑色1=红色2=绿色3=棕褐色4=蓝色5=紫色6=青色7=白色. 
#  如果你传给这个函数错的参数, 
#+ 它就会以代码65退出, 
#+ 没有其他的信息打印到标准出错上. 
# 
