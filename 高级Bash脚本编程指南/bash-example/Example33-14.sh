...
#+ 你可以赢得3.75美元. 
# 
#  脚本已经在GNU/Linux操作系统上测试过OS, 
#+ 测试终端有xterm 和rxvt, 及konsole. 
...
#  注: "tput cup" 表示在终端左上角的0 0 位置, 
#+ echo 是在终端的左上角的1 1 位置. 
move_and_echo() { 
echo -ne "\E[${1};${2}H""$3" 
} 
